...
from configs.__base__.cfg_model_rdpp import cfg_model_rdpp
from configs.__base__.cfg_model_msflow import cfg_model_msflow
from configs.__base__.cfg_model_inpformer import cfg_model_inpformer
